...
public class TestScene {
    ...
    private void initButtonBackTest() {
        Utils.initGoToAnotherSceneWithClosePreviousButton(buttonBackTest, "hello-view.fxml", "Главное меню");
    }
    ...
    private void openTestParsing(String testNumber){
        File file = new File("content/tests");
        ...
        parseQuestions("content/tests/" + nedentTestFileName, testNumber);
    }
